  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-[1520px] px-6 pb-32 pt-[8rem] md:px-12 md:pb-40 md:pt-48 lg:px-20">
        ...
        >
          <span className="font-mono text-[0.65rem] uppercase 0.45em] text-accent/25">{t("sideLabel")}</span>
              ...
              >
                {[t("tagDesign"), t("tagStrategy"), t("tagMotion")].map((tag, i) => (
                  <div key={tag} className="flex flex-col gap-1.5">
                    ...
                    />
                    <span className="font-mono text-[0.6rem] uppercase 0.35em] text-accent/30">
                      {tag}
                    </span>
                  </div>
                ))}
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[0.65rem] uppercase 0.42em] text-accent/20">
              Create Core
            </span>
            <div className="h-1 w-1 rounded-full bg-accent/25" />
          </div>
