            ...
            <EditorialReveal key={step.num} delay={0.12 + i * 0.08} y={28}>
              <div className="group relative overflow-hidden bg-background p-8 md:p-10">
                ...
                <div className="mb-5 flex items-center gap-2">
                  ...
                  <span className="font-mono text-[0.65rem] uppercase  text-accent/35">
                    {tAbout("stepLabel")} {step.num}
                  </span>
                </div>

                <h3 className="relative mb-4 font-serif text-[1.75rem] leading-[0.95]  text-accent md:text-[2rem]">
                  {step.title}
                </h3>
